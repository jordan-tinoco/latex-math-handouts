...
\newtcbtheorem[number within=section]{section-example.tcb}{Ejemplo}
{
    enhanced,
    frame empty,
    interior empty,
...
\newtcbtheorem[number within=section]{section-definition.tcb}{Definición}
{
    enhanced,
    frame empty,
    interior empty,
...
\newtcbtheorem[number within=section]{section-lemma.tcb}{Lema}
{
    enhanced,
    frame empty,
    interior empty,
