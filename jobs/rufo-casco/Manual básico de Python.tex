...
\begin{document}
    ...
    A esto se le conoce como bifurcaciones puesto que genera dos opciones en cómo puede ejecutar el programa, dando como resultado
    ...
    Los cíclos o cíclos son una parte esencial de la programación.
    ...
    Este es un cíclos infinito, nunca termina.

    Detengamos el cíclo justo después de la primera iteración:
