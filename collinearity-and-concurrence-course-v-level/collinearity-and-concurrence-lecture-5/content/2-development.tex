...
\begin{proof}
    ...
    \begin{multicols}{2}
        ...
        \end{figure}
        Al usar el teorema de \textbf{Menelao} tres veces en el \theTriangle{XYZ}, primero con la transversal $A - B - M$, después con la transversal $P - C - D$ y finalmente con $F - N - E$, respectivamente, obtenemos que
        \begin{align*}
