...
\begin{proof}
    ...
    Pero este producto es igual a 1, ya que se cumple el teorema de Menelao para el triángulo $ADE$ con respecto a la transversal $B-C-F$.
...
\begin{section-theorem.tcb}[Teorema de Pappus]\label{pappus-theorem}
...
\begin{proof}
    ...
    \begin{multicols}{2}
        ...
        Dado que $M$, $N$ y $P$ son laterales a $\triangle XYZ$, podemos usar el~\refTheorem{\ref{menelaus-theorem}} para tratar de probar que son colineales, es decir necesitamos probar que
        \[
    ...
    Para lograr esto, usaremos el~\refTheorem{\ref{menelaus-theorem}} tres veces en el $\triangle XYZ$ con las transversales $C - N - E$, $A - P - F$ y $D - M - B$, respectivamente, obtendremos
    \[
    ...
    Rápidamente, vemos que usando el~\refTheorem{\ref{menelaus-theorem}} dos veces más en $\triangle XYZ$, pero ahora con las transversales $A - B - C$ y $D - E - F$, obtenemos
    \[
...
Claramente, al igual que el \refTheorem{\ref{pappus-theorem}}, el teorema de Desargues tiene muchas más configuraciones.
...
\begin{proof}
    ...
    \]
    que por el~\refTheorem{\ref{menelaus-theorem}} aplicado al triángulo $\triangle ABC$, significa que los puntos $P$, $R$ y $Q$ son colineales, es decir $\triangle ABC$ y $\triangle XYZ$ están en perspectiva con respecto a la recta $PQ$.
...
\begin{itemize}
    ...
    Ejemplos, una recta la podemos considerar tanto como un triángulo degenerado o cuadrilátero degenerado, un pentagono como un héxagono degenerado, etc.
    \item Tanto el teorema de Menelao, Pappus como Desargues tienen su versiones degeneradas, las cuales pueden verse afectadas.
